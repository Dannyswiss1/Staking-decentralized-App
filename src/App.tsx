...
const App = () => {
  ...
  const [functionExecutionType, setFunctionExecutionType] =
  ...
  return (
    <div className="min-h-screen h-full">
      ...
      />
      <nav className="py-3 shadow shadow-[rgba(243, 239, 239, 0.1)]">
        <div className="flex items-center justify-between container">
          <h1 className="text-white madimi-one-regular text-3xl">Stake.dApp</h1>
          <w3m-button />
        </div>
      </nav>
